...
- Velocity suggestions (Phase 1 optional start): computeSuggestedCapacity helper (avg historical completed pts) + dynamic placeholder hint (~N from history) in +New Interval capacity field.
