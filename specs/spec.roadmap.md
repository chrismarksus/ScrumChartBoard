...
- Optional: GitHub import for issues as cards, basic velocity-based planning suggestions in the planner. ✅ started (computeSuggestedCapacity helper + dynamic placeholder hint in +New Interval form when past done points exist).
