...
- Finish remaining MVP items from existing specs (editing intervals/themes, capacity warnings, etc.). ✅ started (interval name/dates editing + basic capacity warning in Planner).
